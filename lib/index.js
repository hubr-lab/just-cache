...
class JustCache extends EventEmitter {
  ...
  constructor (options = {}) {
    ...
    if (options.limit !== null && options.limit !== undefined) {
      ...
      this._options.limit = optionsDefault.limit;
    }
    ...
    if (options.ttl !== null && options.ttl !== undefined) {
      ...
      this._options.ttl = optionsDefault.ttl;
    }
    ...
    if (options.persistent !== null && options.persistent !== undefined) {
      ...
      this._options.persistent = optionsDefault.persistent;
    }
    ...
    storage.all()
      .then((result) => {
        for (const key in result) {
          ...
          self._data[key] = new CacheControl(
            value,
            ttl
